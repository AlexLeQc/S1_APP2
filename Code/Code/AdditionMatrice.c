...
{
	printf("\n\t\t\tPlan de test fonction addition matrice\n");
	printf("%s",ligne);
	printf("%s",tableau);
	printf("%s",ligne);	
	int matriceA[3][2] = {{1000,1000},{1000,1000},{1000,1000}};
	int matriceB[3][2] = {{-1000,-1000},{-1000,-1000},{-1000,-1000}};
	int matriceAtt[3][2] = {{0,0},{0,0},{0,0}};
	int matriceR[3][2];
