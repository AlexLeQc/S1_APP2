...
int main(void)
{
	...
	printf("%s",ligne);
	printf("\n\nNote: Il est important de comprendre que les valeurs ne sont pas exacte, car la serie utilise seulement 5 termes. Avec    plus de termes, la serie serait plus pres de la reponse exacte.\n");
}
